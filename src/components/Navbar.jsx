  ...
  return (
    <div className="flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70">
      ...
      <div
        ...
        } max-sm:absolute max-sm:top-0 max-sm:bottom-0 max-sm:right-0 max-sm:min-h-screen max-sm:h-full max-sm:flex-col max-sm:bg-primary max-sm:text-white max-sm:pt-20 flex sm:items-center gap-5 transition-all`}
      >
        <img
          src={assets.close_icon}
          alt=""
          className="w-6 h-6 absolute right-6 top-6 sm:hidden"
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <img
          ...
          className={`w-8 sm:hidden ${sidebarOpen ? "hidden" : "block"}`}
        />
        <a
          href="#contact-us"
